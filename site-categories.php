			 ...
			 && (isset($_GET['tag_ID']))) {
				...
				if ( version_compare( $wp_version, '3.8', '>=' )) {
					if (function_exists('wp_enqueue_media')) {
						...
						$site_categories_data['image_view_title_text'] = __('Wähle ein Bild für die Blog-Kategorie', SITE_CATEGORIES_I18N_DOMAIN);
...
<?php */ ?>
	...
	function load_config() {
		...
		$defaults = array(
			...
			'sites'										=>	array(
				...
				'return_link_label'						=>	__('Zurück', SITE_CATEGORIES_TAXONOMY),
				'return_link'							=>	1,
				'open_blank'							=>	0,
				'per_page'								=>	5,
				'icon_show'								=>	1,
	...
	function register_taxonomy_proc() {
		...
		$labels = array(
			...
			'parent_item'			=>	__( 'Übergeordnete Seiten-Kategorie', SITE_CATEGORIES_I18N_DOMAIN ),
			'parent_item_colon'		=>	__( 'Übergeordnete Seiten-Kategorie:', SITE_CATEGORIES_I18N_DOMAIN ),
			...
			'add_new_item'			=>	__( 'Neue Seiten-Kategorie hinzufügen', SITE_CATEGORIES_I18N_DOMAIN ),
	...
	function on_load_page_main_site() {
		...
		add_meta_box('site-categories-settings-main-admin-display_selection-options-panel', 
			__('Auswahloptionen für Seiten-Kategorien', SITE_CATEGORIES_I18N_DOMAIN), 
		...
		add_meta_box('site-categories-settings-main-categories-display-options-panel', 
			__('Anzeigeoptionen für Landeseite Kategorien', SITE_CATEGORIES_I18N_DOMAIN), 
		...
		add_meta_box('site-categories-settings-main-sites-display-options-panel', 
			__('Anzeigeoptionen für Landeseiten', SITE_CATEGORIES_I18N_DOMAIN), 
		...
		add_meta_box('site-categories-settings-main-sites-signup-form-options-panel', 
			__('Optionen für das Neue Seite-Anmeldeformular', SITE_CATEGORIES_I18N_DOMAIN), 
	...
	function on_load_page_site() {
		...
		add_meta_box('site-categories-settings-site-categories-panel', 
			__('Wähle die Kategorien für diese Seite aus', SITE_CATEGORIES_I18N_DOMAIN), 
	...
	function admin_plugin_help() {
		...
		*/
		$screen_help_text['site-categories-help-overview'] = '<p>' . __( 'Dieses Einstellungsfeld steuert verschiedene Anzeigeoptionen für die Lande-Seite. Diese Zielseite wird nur auf der primären Seite gehostet. Über die Optionen auf dieser Seite kannst Du das Layout der Seiten-Kategorienelemente steuern.', SITE_CATEGORIES_I18N_DOMAIN ) . '</p>';
		...
		$screen_help_text['site-categories-help-overview'] .= '<li><strong>'. __('Auswahloptionen für Seiten-Kategorien', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Mit dieser Auswahl kannst Du steuern, wie die Seiten-Kategorien von anderen Seiten-Administratorbenutzern angezeigt und ausgewählt werden.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-overview'] .= '<li><strong>'. __('Anzeigeoptionen für Landeseitenkategorien', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Diese Auswahl steuert die Ausgabe der Seiten-Kategorien auf der Landeseite. Hier kannst Du den Stil, die Symbole, die Anzahl der Kategorien pro Seite usw. steuern.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-overview'] .= '<li><strong>'. __('Anzeigeoptionen für Landeseiten', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Diese Auswahl steuert die Ausgabe der Seiten auf der Landeseite. Hier kannst Du den Stil, die Symbole, die Anzahl der Webseiten pro Seite usw. steuern.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		
		$screen_help_text['site-categories-help-overview'] .= '<li><strong>'. __('Neue Optionen für das Seiten-Anmeldeformular', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Diese Auswahl steuert, wie die Optionen für Seiten-Kategorien im Anmeldeformular für neue Seiten angezeigt werden.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		*/
		...
		$screen_help_text['site-categories-help-settings-landing'] .= '<li><strong>'. __('Landeseite auswählen', SITE_CATEGORIES_I18N_DOMAIN). '</strong> - '. __('Wähle die Seite aus, die als Landeseite für Seiten-Kategorien fungieren soll. Die Zielseite wird automatisch am unteren Rand des Seiteninhalts eingefügt.', SITE_CATEGORIES_I18N_DOMAIN). '</li>';
		$screen_help_text['site-categories-help-settings-landing'] .= '</ul>';
		...
		*/	
		$screen_help_text['site-categories-help-settings-selection'] = '<p>'. __('Mit dieser Auswahl kannst Du steuern, wie die Seiten-Kategorien von anderen Seiten-Administratorbenutzern angezeigt und ausgewählt werden.', SITE_CATEGORIES_I18N_DOMAIN).'</p>';
		...
		*/		
		...
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Anzeigestil', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Der Anzeigestil gibt an, wie die Seiten-Kategorien auf der Seite dargestellt werden. In der Dropdown-Liste kannst Du eine einfache Liste auswählen oder erweiterte Anzeigeoptionen wie Raster oder Akkordeon ausprobieren.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Kategorien pro Seite', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Dies ist die Anzahl der Kategorien, die auf einer bestimmten Seite angezeigt werden sollen. Wenn Du Hunderte von Seiten-Kategorien hast, möchtest Du wahrscheinlich nicht, dass diese alle auf einer einzigen Seite angezeigt werden. Das wären zu viele Informationen, als dass der Benutzer sie verdauen könnte. So kannst Du die Anzahl der Kategorien auf etwas Verwaltbares wie 20, 50 oder 100 einstellen.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Ordnen nach', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Standardmäßig werden die angezeigten Seiten-Kategorien nach Name sortiert. Mit dieser Option kannst Du die Reihenfolge nach Deinen Wünschen anpassen.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Leere Kategorien ausblenden', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Wenn einer Seiten-Kategorie keine Seiten zugewiesen sind, möchtedt Du sie möglicherweise aus der Liste ausblenden.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Zähler anzeigen', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Ähnlich wie beim Ausblenden kannst Du dem Benutzer mit dieser Option anzeigen, wie viele Webseiten jeder Webseitenkategorie zugeordnet sind.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Symbole anzeigen', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Im Rahmen der Einrichtung der Seiten-Kategorien kannst Du ein Bild hochladen oder auswählen, um die Seiten-Kategorie darzustellen. Wenn Du diese Option verwendest, werden diese Symbole als Teil der Anzeigeausgabe angezeigt.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Symbolgröße', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Wenn Du Seiten-Kategoriesymbole anzeigen möchtest, kannst Du die Größe dieser Symbole mit dieser Option steuern.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		*/			
		...
		$screen_help_text['site-categories-help-settings-landing-sites'] .= '<li><strong>'. __('Webseiten pro Seite', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Dies ist die Anzahl der Webseiten, die auf einer bestimmten Seite angezeigt werden sollen. Wenn Du Hunderte von Webseiten in einer einzigen Kategorie hast, möchtest Du wahrscheinlich nicht, dass diese alle auf einer einzigen Seite angezeigt werden. Das wären zu viele Informationen, als dass der Benutzer sie verdauen könnte. Du kannst also die Anzahl der Webseiten auf überschaubare Werte wie 20, 50 oder 100 einstellen.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-settings-landing-sites'] .= '<li><strong>'. __('Seiten-Beschreibung anzeigen', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Auf der Seite Seiten-Administratoreinstellungen kann der Administrator eine Beschreibung für die Seite eingeben. Dies ähnelt der Beschreibung der Seiten-Kategorie. Wenn von der Seite bereitgestellt, wird dies als Teil der Seitenausgabe angezeigt.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		$screen_help_text['site-categories-help-settings-landing-sites'] .= '<li><strong>'. __('Symbolgröße', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Wenn Du Seiten-Symbole anzeigen möchtest, kannst Du die Größe dieser Symbole mit dieser Option steuern.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		*/
		$screen_help_text['site-categories-help-signup-form'] = '<p>'. __('Diese Auswahl steuert, wie die Optionen für Seiten-Kategorien im Anmeldeformular für neue Seiten angezeigt werden.', SITE_CATEGORIES_I18N_DOMAIN) .'</p>';
		...
		$screen_help_text['site-categories-help-signup-form'] .= '<li><strong>'. __('Auswahl der Seiten-Kategorien erforderlich', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Ermöglicht es den neuen Seiten-Administrator zu zwingen, Optionen für Seiten-Kategorien auszuwählen. Wenn festgelegt, muss der Administrator festlegen ', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		$screen_help_text['site-categories-help-signup-form'] .= '<li><strong>'. __('Beschriftung für Dropdown-Listen für Seiten-Kategorien', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Mit dieser Option kannst Du eine alternative Formularbezeichnung für die Dropdown-Auswahl "Seiten-Kategorien" verwenden. Vielleicht etwas Beschreibenderes für den Benutzer.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		$screen_help_text['site-categories-help-signup-form'] .= '<li><strong>'. __('Beschriftung für Seiten-Kategorien Beschreibung', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Mit dieser Option kannst Du eine alternative Formularbezeichnung für das Feld Seitenbeschreibung verwenden.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		$screen_help_text['site-categories-help-signup-form'] .= '</ul>';
		...
		if ( version_compare( $wp_version, '3.3.0', '>' ) ) {
			...
			if ((isset($_REQUEST['page'])) && ($_REQUEST['page'] == "bcat_settings")) {
				...
				$screen->add_help_tab( array(
					...
					'title'		=> __('Einstellungsübersicht', SITE_CATEGORIES_I18N_DOMAIN ),
				...
				$screen->add_help_tab( array(
					...
					'title'		=> __('Auswahloptionen für Seiten-Kategorien', SITE_CATEGORIES_I18N_DOMAIN ),
				...
				$screen->add_help_tab( array(
					...
					'title'		=> __('Anzeigeoptionen für Kategorien', SITE_CATEGORIES_I18N_DOMAIN ),
				...
				$screen->add_help_tab( array(
					...
					'title'		=> __('Anzeigeoptionen für Webseiten', SITE_CATEGORIES_I18N_DOMAIN ),
				...
				$screen->add_help_tab( array(
					...
					'title'		=> __('Neue Optionen für das Seiten-Anmeldeformular', SITE_CATEGORIES_I18N_DOMAIN ),
	...
	function site_plugin_help() {
		...
		$screen_help_text['site-categories-page-settings'] = '<p>' . __( 'Auf dieser Seite kannst Du diese Seite verschiedenen Seiten-Kategorien zuordnen. Die Seiten-Kategorien sind global für dieses Multisite-Netzwerk von Seiten und Geschäften innerhalb des primären Standorts.', SITE_CATEGORIES_I18N_DOMAIN). '</p>';
		$screen_help_text['site-categories-page-settings'] .= '<ul>';
		$screen_help_text['site-categories-page-settings'] .= '<li><strong>'. __('Wähle die Kategorien für diese Seite aus', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Abhängig von der Anzahl der vom Superadministrator zugelassenen Kategorien wird eine Reihe von Dropdown-Listen angezeigt, in denen Du die Seiten-Kategorie auswählen kannst, der diese Seite zugeordnet werden soll.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		$screen_help_text['site-categories-page-settings'] .= '<li><strong>'. __('Seitenbeschreibung', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Auch auf dieser Seite kannst Du eine optionale Site-Beschreibung eingeben. Die Seiten-Beschreibung wird auf der Landeseite Seiten-Kategorien der primären Seite verwendet.', SITE_CATEGORIES_I18N_DOMAIN ) . '</li>';
	...
	function settings_panel_main_site() {
		...
		<div id="site-categories-panel" class="wrap site-categories-wrap">
			<?php screen_icon(); ?>
			<h2><?php _ex("Einstellungen für Seiten-Kategorien", "Seiten-Kategorien Neuer Seitentitel", SITE_CATEGORIES_I18N_DOMAIN); ?></h2>
	...
	function settings_panel_site() {
		...
		<div id="site-categories-panel" class="wrap site-categories-wrap">
			...
			<div id="poststuff" class="metabox-holder">
				<div id="post-body" class="">
					<div id="post-body-content" class="site-categories-metabox-holder-main">
						<p><?php _e('Aus den folgenden Optionen kannst Du die Seiten-Kategorien auswählen, die Deinr Seite am besten beschreiben. Gib außerdem eine Beschreibung an, die auf der Zielseite für Seiten-Kategorien angezeigt werden kann.', SITE_CATEGORIES_I18N_DOMAIN); ?><?php
	...
	function settings_main_categories_display_options_panel() {
		...
		<tr class="form-field" >
			...
			<td>
				<div class="site-categories-parent-child-left">
					<p class="site-categories-accordion-options site-categories-grid-options" style="<?php echo $display_grid_accordion_options; ?>"><?php _e('Übergeordnete',  SITE_CATEGORIES_I18N_DOMAIN); ?></p>
					...
					<select id="site-categories-show-style" name="bcat[categories][show_style]">
						...
						<option value="select-nested" <?php if ($this->opts['categories']['show_style'] == "select-nested") { 
							echo 'selected="selected" '; } ?>><?php _e('Dropdown (auswählen) Verschachtelt', SITE_CATEGORIES_I18N_DOMAIN); ?></option>
						<option value="select-flat" <?php if ($this->opts['categories']['show_style'] == "select-flat") { 
							echo 'selected="selected" '; } ?>><?php _e('Dropdown (auswählen)', SITE_CATEGORIES_I18N_DOMAIN); ?></option>
					</select>
				</div>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-show-counts"><?php _e('Zähler anzeigen', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<div class="site-categories-parent-child-left">
		...
		<tr class="form-field form-field site-categories-non-select-options" <?php if (($this->opts['categories']['show_style'] == "select-flat") || ($this->opts['categories']['show_style'] == "select-nested")) { echo ' style="display: none" '; } ?>>
			<th scope="row">
				<label for="site-categories-icons"><?php _e('Symbolgröße', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<div class="site-categories-parent-child-left">
		...
		<tr class="form-field form-field site-categories-non-select-options" <?php if (($this->opts['categories']['show_style'] == "select-flat") || ($this->opts['categories']['show_style'] == "select-nested")) { echo ' style="display: none" '; } ?>>
			...
			<td>
				<p class="description"><?php _e('Lade ein Bild hoch oder wähle eines aus, das als Standardkategoriesymbole verwendet werden soll. Stelle sicher, dass es mindestens so groß ist wie die oben angegebene Symbolgröße. Eine quadratische Version dieses Bildes wird automatisch generiert.', SITE_CATEGORIES_I18N_DOMAIN) ?></p>
	...
	function settings_main_sites_display_options_panel() {
		...
		<tr class="form-field" >
			<th scope="row">
				<label for="site-categories-sites-header-prefix"><?php _e('Präfix vor dem Namen der Seiten-Kategorie', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-sites-return-link"><?php _e('Zeige Zurück-Link', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<p><?php _e('Der Zurück-Link wird in der Seiten-Liste angezeigt und ist eine Rückkehr zur Haupt-Landingpage der Seiten-Kategorien. Keine Rückkehr zur vorherigen Seite, die der Benutzer angezeigt hat.', SITE_CATEGORIES_I18N_DOMAIN); ?></p>
		...
		<tr class="form-field" >
			<th scope="row">
				<label for="site-categories-sites-return-link-label"><?php _e('Zeige Zurück-Link Etikett', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
...
<?php  ?>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-sites-open-blank"><?php _e('Öffne Seiten-Links in einem neuen Fenster', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-site-icon-size"><?php _e('Symbolgröße', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
	...
	function settings_main_sites_signup_form_options_panel() {
		...
		<tr>
			<th scope="row">
				<label for="site-categories-signup-category-label"><?php _e('Beschriftung für Dropdown-Listen für Seiten-Kategorien', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<input type="text" class='widefat' id="site-categories-signup-category-label" name="bcat[sites][signup_category_label]" 
					...
					<p class="description"><?php _e("Die Beschriftung wird über der Anzahl der Kategorie-Dropdowns angezeigt", SITE_CATEGORIES_I18N_DOMAIN); ?></p>					
			</td>
		</tr>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-signup-description-label"><?php _e('Beschriftung für Seiten-Kategorien Beschreibung', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<input type="text" class='widefat' id="site-categories-signup-description-label" name="bcat[sites][signup_description_label]" 
					...
					<p class="description"><?php _e("Das Etikett wird über der Seiten-Beschreibung angezeigt", SITE_CATEGORIES_I18N_DOMAIN); ?></p>					
			</td>
		</tr>
	...
	function settings_main_admin_display_options_panel() {
		...
		<tr class="form-field" >
			<th scope="row">
				<label for="site-categories-landing-page"><?php _e('Landeseite auswählen', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<?php
				...
				<?php	
					...
					wp_dropdown_pages( array( 
							...
							'echo'				=> 1, 
							'show_option_none'	=> __( '&mdash; Wählen &mdash;' ), 
							'option_none_value' => '0', 
					...
					if ($this->opts['landing_page_id']) {
						?><p class="description"><?php _e('Die Liste der Seiten-Kategorien wird an die ausgewählte Seite angehängt:', 
		...
		<tr class="form-field" >
			<th scope="row">
				<label for="site-categories-use_rewrite"><?php _e('Pretty URLs für Kategorien', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				...
				<p class="description"><?php _e('Verwende hübsche URLs, wenn Du Webseiten aus einer ausgewählten Kategorie anzeigst. Wenn die Zielseite auf die Startseite eingestellt ist, werden hübsche URLs automatisch auf Nein gesetzt', SITE_CATEGORIES_I18N_DOMAIN); ?></p>
			</td>
		</tr>
		</table>
		<?php		
	...
	function settings_main_admin_display_selection_options_panel() {
			...
			<tr>
				...
				<td>
					<input type="text" class='widefat' id="site-categories-signup-category-minimum" name="bcat[sites][signup_category_minimum]" 
						...
						<p class="description"><?php _e("Die Mindestanzahl der einzustellenden Seiten-Kategorien. Kann für kein Minimum leer sein. Dieser Wert sollte kleiner sein als der Wert der unten angegebenen 'Maximalen Site-Kategorien'.", SITE_CATEGORIES_I18N_DOMAIN); ?></p>
		...
		<tr>
			...
			<td>
				<p class="description"><?php _e('Mit dieser Option kannst Du die Anzahl der für die Seite verfügbaren Seiten-Kategorien begrenzen. Diese Option fügt eine Reihe von Dropdown-Formularelementen auf der Seite "Allgemeine Einstellungen" hinzu, auf denen der Administrator die Kategorien für seine Seite festlegen kann.', SITE_CATEGORIES_I18N_DOMAIN); ?></p>
				...
				<?php
					if (function_exists('is_pro_user')) {
						...
						if (is_pro_user(get_current_user_id())) {
							...
							if ($levels) {
								?>
								<p class="description"><?php _e('Du kannst Deinen Blog-Hosting-Level mehr Auswahlmöglichkeiten für Seiten-Kategorien anbieten',
								 SITE_CATEGORIES_I18N_DOMAIN); ?></p>
		...
		<tr>
			...
			<td>
				<p class="description"><?php _e('Lege die Standardkategorie fest, wenn der Seiten-Administrator keine Seiten-Kategorie auswählt.', SITE_CATEGORIES_I18N_DOMAIN); ?></p>
				<?php
					$bcat_args = array(
						'taxonomy'			=>	SITE_CATEGORIES_TAXONOMY,
						'hierarchical'		=>	true,
						...
						'show_count'		=>	1,
						'show_option_none'	=>	__('Keine ausgewählt', SITE_CATEGORIES_I18N_DOMAIN), 
		...
		<tr>
			<th scope="row">
				<label for="site-categories-signup-category-parent-selectable-yes"><?php _e('Kategorie Eltern wählbar', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
		...
		if ($category && $data['term']) {
			...
			if (count($sites) < $args['per_page']) {
				...
				if ($data['current_page'] < $data['total_pages']) {
					...
					$data['next']['link_label'] = __('Nächste Seite', SITE_CATEGORIES_I18N_DOMAIN);
				}
			}
	...
	function bcat_signup_blogform() {
		...
		while(true) {
			...
			$bcat_args = array(
				...
				'hide_empty'		=>	false,
				'exclude'			=>	$cat_excludes,
				'show_option_none'	=>	__('Keine gewählt', SITE_CATEGORIES_I18N_DOMAIN), 
				'name'				=>	'bcat_site_categories['. $cat_counter .']',
				'class'				=>	'bcat_category',
			...
			?><li><?php 
				...
				if ((isset($this->opts['sites']['signup_category_required'])) && ($this->opts['sites']['signup_category_required'] == 1)) { 
					if ($cat_counter <= intval($signup_category_minimum)) {
						?><span class="site-categories-required"><?php _e('(* benötigt)', SITE_CATEGORIES_I18N_DOMAIN); ?></span><?php
					}
				}
			?></li><?php
	...
	function bcat_wpmu_validate_blog_signup($result) {
		...
		if ((isset($this->opts['sites']['signup_category_required'])) && ($this->opts['sites']['signup_category_required'] == 1)) {
			...
			if (count($bcat_site_categories) < $this->opts['sites']['signup_category_minimum']) {
				$format = __('Du musst mindestens %d eindeutige Kategorien auswählen', SITE_CATEGORIES_I18N_DOMAIN);
