...
class Bcat_WidgetCloud extends WP_Widget {
	...
	function __construct () {
		$widget_ops = array('classname' => __CLASS__, 'description' => __('Zeigt eine Tag-Cloud mit Seiten-Kategorien an.', SITE_CATEGORIES_I18N_DOMAIN));
		parent::__construct(__CLASS__, __('Seiten-Kategorien Wolke', SITE_CATEGORIES_I18N_DOMAIN), $widget_ops);
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php 
				_e('Anzahl der anzuzeigenden Elemente: (leer für alle)', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php 
				_e('Seiten-Kategorien anzeigen:', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			...
			<?php
				...
				$bcat_args = array(
					...
					'hide_empty'		=>	false,
					'show_count'		=>	true,
					'show_option_none'	=>	__('Alle Kategorien', SITE_CATEGORIES_I18N_DOMAIN), 
			...
			?><input type="checkbox" id="<?php echo $this->get_field_id( 'include_parent' ); ?>" <?php if ($instance['include_parent'] == "on") {
				...
				_e('Inkl. Übergeordnete:', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
		</p>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('orderby') ?>"><?php _e('Sortierung:', SITE_CATEGORIES_I18N_DOMAIN); ?></label><br />
			<select id="<?php echo $this->get_field_id( 'orderby' ); ?>" 
				...
				<option value="count" <?php if ($instance['orderby'] == "count") { echo ' selected="selected" '; }?>><?php 
					_e('Anzahl', SITE_CATEGORIES_I18N_DOMAIN); ?></option>
			</select>
			<select id="<?php echo $this->get_field_id( 'order' ); ?>" 
				...
				<option value="RAND" <?php if ($instance['order'] == "RAND") { echo ' selected="selected" '; }?>><?php 
					_e('Zufällig', SITE_CATEGORIES_I18N_DOMAIN); ?></option>
			</select>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'smallest' ); ?>"><?php 
				_e('Kleine Schriftgröße:', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'largest' ); ?>"><?php 
				_e('Große Schriftgröße:', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'unit' ); ?>"><?php 
				_e('Schriftgrößeneinheit:', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			...
			<select id="<?php echo $this->get_field_id( 'unit' ); ?>" 
				...
				<option value="%" <?php if ($instance['unit'] == "%") { echo ' selected="selected" '; }?>><?php 
					_e('% Prozentsatz', SITE_CATEGORIES_I18N_DOMAIN); ?></option>
				...
				<option value="cm" <?php if ($instance['unit'] == "cm") { echo ' selected="selected" '; }?>><?php 
					_e('cm Zentimeter', SITE_CATEGORIES_I18N_DOMAIN); ?></option>
		...
		<p>
			<label for="<?php echo $this->get_field_id('open_blank') ?>"><?php _e('Öffne Links in einem neuen Fenster:', SITE_CATEGORIES_I18N_DOMAIN); ?></label><br />
		...
		<p>
			<label for="<?php echo $this->get_field_id('show_more_link') ?>"><?php _e('Landeseite Link unter Cloud-Liste:', SITE_CATEGORIES_I18N_DOMAIN); ?></label><br />
